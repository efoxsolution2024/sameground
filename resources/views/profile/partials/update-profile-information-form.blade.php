<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div class="flex items-center" x-data="picturePreview()">
            <div class="rounded-full bg-amber-500 mr-2">
                <span class="text-xs text-center text-gray-500">
                <img :src="imageUrl ? imageUrl : '{{ Auth::user()->picture ? asset(Auth::user()->picture) : URL('images/user-default-avatar.png') }}'" alt="Photo de profil"        class="w-24 h-24 rounded-full object-cover">
                </span>
            </div>
        <div>
