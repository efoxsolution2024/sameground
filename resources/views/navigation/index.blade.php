<x-app-layout>
  ...
  <div class="py-12 bg-indigo-100 mx-10 w-[70.333%] rounded-3xl">
                  ...
                  <div class="max-w-sm w-[50%] bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
                    ...
                    <div class="grid grid-cols-2 py-3">
                      <dl>
                        ...
                        <dd class="leading-none text-xl font-bold text-green-500 dark:text-green-400">{{$firstquarterNew}}</dd>
                      </dl>
                      <dl>
                        <dt class="text-base font-normal text-gray-500 dark:text-gray-400 pb-1">Expired Account</dt>
                        <dd class="leading-none text-xl font-bold text-red-600 dark:text-red-500">{{$firstquarterExpired}}</dd>
                      </dl>
                    </div>
