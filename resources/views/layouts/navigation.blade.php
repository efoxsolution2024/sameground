<nav x-data="{ open: false }" class="bg-white float-left border-b border-gray-100  md:w-64">
    ...
    <div class="flex-col md:w-64 md:flex md:flex-row md:min-h-screen fixed z-10" style="z-index: 999;">
        <div @click.away="open = false" class="flex flex-col flex-shrink-0 w-full text-gray-700 bg-gray-800 md:w-64 dark-mode:bg-gray-800 main-logo" x-data="{ open: false }" >
            <div class="flex flex-row items-center justify-between flex-shrink-0 px-8 py-4 mx-auto mt-5">
                <a href=" {{route('dashboard')}}" class="text-xl font-semibold tracking-widest text-white uppercase rounded-lg dark-mode:text-white focus:outline-none focus:shadow-outline text-center mb-10">
                    
                    <figure><img src="{{asset('images/main-logo.png')}}" alt="" class="float-left"></figure>
                ...
                <button class="rounded-lg md:hidden focus:outline-none focus:shadow-outline" @click="open = !open">
                    ...
                    <x-nav-link :href="route('sop_generator')" :active="request()->routeIs('sop_generator')"> SOP Generator </x-nav-link>    
                    <x-nav-link :href="route('test')" :active="request()->routeIs('test')"> Graph Test </x-nav-link>  
