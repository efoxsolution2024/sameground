    ...
    <div class="md:container md:mx-auto bg-indigo-50 rounded-3xl py-14 border px-10 box-border shadow mb-16 relative "> 
        <div class="space-y-12">
            <div class="flex justify-between mb-10 items-center">
                ...
                <a href=" {{route('user.index')}} " class="bg-indigo-600 px-3 py-2 rounded-md text-white hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Back</a>
            </div>   
         </div>
            {{-- Form --}}
            ...
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            <input type="text" name="name" id="name" autocomplete="given-name" readonly value="{{ $user->name }}" class="block w-full rounded-md border-0 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-indigo-50 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 ">
                        </div>
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-3">
                        <label for="name" class=" block text-base font-base font-semibold leading-6 text-gray-900">Email</label>
                        <div class="mt-2">
                            <input type="text" name="name" id="name" autocomplete="given-name" readonly value="{{ $user->email }}" class="block w-full rounded-md border-0 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-indigo-50 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 ">
                        </div>
                            <div class="text-red-500 mt-2">@error('name') {{ $message }} @enderror</div>
                    </div>
                </div>  
