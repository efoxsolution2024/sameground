            ...
            <tbody>
                @foreach ($users as $user)       
                    <tr class="border-b-1 border-gray-300 text-[15px] ">  
                        <td class="pl-4 py-4"> {{ $user->name  }} </td> 
                        ...
                        <td  class="py-4 w-[8%]"><a href="" class="pl-6 pr-0 text-indigo-600 font-medium">Permission</a></td>                        
                        <td  class="py-4 w-[1%]"><a href="{{ route('user.edit', $user->id) }}" class="pl-6 pr-0 text-indigo-600 font-medium">Edit</a></td>
                        <td class="py-4">
